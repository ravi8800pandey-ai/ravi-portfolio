...
This repository is a static website: no build command is needed. In GitHub, open **Settings → Pages**, select **Deploy from a branch**, then choose the `main` branch and the `/(root)` folder.
